...
tmp.grd <- expand.grid(seq(1,length(nn.vec)),
                       ...
                       seq(1,length(sig.12.vec)), stringsAsFactors = FALSE)

pp <- which(tmp.grd[,1] == 3 & tmp.grd[,2] == 2 & tmp.grd[,3] == 2 & tmp.grd[,4] == 2 & tmp.grd[,5] == 2 & tmp.grd[,6] == 2)
pp
...
result <- foreach(ind = 1:nrow(tmp.grd),
                  ...
                  .options.RNG = 12345) %dorng% {
                    ...
                    plt.nam <- paste(fig.dir, "figure_01_", i1, "_", i2, "_", i3, "_", i4, "_", i5, "_", i6, ".svg", sep = "")
                    svg(plt.nam)
                    ...
                    plt.nam <- paste(fig.dir, "figure_02_", i1, "_", i2, "_", i3, "_", i4, "_", i5, "_", i6, ".svg", sep = "")
                    svg(plt.nam)
                    ...
                    plt.nam <- paste(fig.dir, "figure_03_", i1, "_", i2, "_", i3, "_", i4, "_", i5, "_", i6, ".svg", sep = "")
                    svg(plt.nam)
