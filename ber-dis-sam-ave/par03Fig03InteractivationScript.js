...
document.getElementById("slider01Id").setAttribute("data-slider-value", (par01Vec[par01Ini]).toString());
...
document.getElementById("slider02Id").setAttribute("data-slider-value", (par02Vec[par02Ini]).toString());
...
document.getElementById("slider03Id").setAttribute("data-slider-value", (par03Vec[par03Ini]).toString());
document.getElementById("sliderValue02Id").innerHTML = par03Str01 + par03Vec[par03Ini] + "\\)";
