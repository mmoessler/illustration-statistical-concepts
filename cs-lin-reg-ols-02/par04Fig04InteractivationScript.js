...
document.getElementById("imageL1N1Id").setAttribute("src", "./figures/figure_01_" + par01Ini + "_" + par02Ini + "_" + par03Ini + "_" + par04Ini + ".svg");
document.getElementById("imageL1N2Id").setAttribute("src", "./figures/figure_02_" + par01Ini + "_" + par02Ini + "_" + par03Ini + "_" + par04Ini + ".svg");
document.getElementById("imageL1N3Id").setAttribute("src", "./figures/figure_03_" + par01Ini + "_" + par02Ini + "_" + par03Ini + "_" + par04Ini + ".svg");
document.getElementById("imageL1N4Id").setAttribute("src", "./figures/figure_04_" + par01Ini + "_" + par02Ini + "_" + par03Ini + "_" + par04Ini + ".svg");
...
document.getElementById("sliderValue04Id").innerHTML = par04Str01 + par04Vec[par04Ini] + "\\)";
