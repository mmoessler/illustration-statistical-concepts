...
load(url("https://github.com/mmoessler/illustration-statistical-concepts/raw/main/simulation-results/ols_b0_sim_res_01.RData"))
...
his_ill_fun(x = his.res[[100]], ii = 100,
            nam.01 = "./illustration-results/ols_b0_sim_res_01_N",
