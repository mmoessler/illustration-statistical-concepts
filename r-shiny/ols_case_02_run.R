...
run_app <- function (url = "https://github.com/mmoessler/illustration-statistical-concepts/raw/main/r-shiny/ols-case-02.zip") {
...
run_app(url = "https://github.com/mmoessler/illustration-statistical-concepts/raw/main/r-shiny/ols-case-02.zip")
