...
run_app <- function (url = "https://github.com/mmoessler/illustration-statistical-concepts/raw/main/r-shiny/ols-case-03.zip") {
  ...
  file.path <- file.path(appdir, "ols_case_03_document.rmd")
  file.path
...
run_app(url = "https://github.com/mmoessler/illustration-statistical-concepts/raw/main/r-shiny/ols-case-03.zip")
