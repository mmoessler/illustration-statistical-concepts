                           ...
                           tabPanel("Sample Draw",
                                    ...
                                    tags$div(HTML("
                                      <span style='font-size: 12pt;'>
                                        ...
                                        The <u>green dots</u> are generated by the 'true' but 'not observable' relationship between \\(Y_{i}\\) and \\(X_{1i}\\), i.e., with controlling for \\(X_{2i}\\). <br>
                                        
                                        The <u>red dots</u> are generatey by the 'potentially false' but 'observable' relationship between \\(Y_{i}\\) and \\(X_{1i}\\), i.e., without controlling for \\(X_{2i}\\). <br>
                                        
                                        <hr>
                                        
                                        The <u>green line</u> is the fitted regression line to the <u>green dots</u> and represents the 'true' but 'not observable' relationship between \\(Y_{i}\\) and \\(X_{1i}\\), i.e., with controlling for \\(X_{2i}\\). <br>
                                        
                                        The <u>red line</u> is the fitted regression line to the <u>red dots</u> and represents 'potentially false' but 'observable' relationship between \\(Y_{i}\\) and \\(X_{1i}\\), i.e., without controlling for \\(X_{2i}\\). <br>
                                        ...
                                        In the scatterplot the green dots represent the relationship between \\(X_{1i}\\) and \\(Y_{X_{2}i}\\) and the red dots represent the relationship between \\(X_{1i}\\) and \\(Y_{i}\\). <br>
                                        
                                        Note, the green dots/line is the 'true' but 'not observable' relationship between \\(Y_{i}\\) and \\(X_{1i}\\) instead, red dots/line is the 'observable' relationship between \\(Y_{i}\\) and \\(X_{1i}\\). <br>
                                        
                                        The question is now under which conditions the regression of the 'observable' observations of \\(Y_{i}\\) on \\(X_{1i}\\) result in the 'true' relationships between \\(Y_{i}\\) on \\(X_{1i}\\). <br>
...
server <- function(input, output) {
  ...
  output$Plot01 <- renderPlot({
    ...
    plot(x = tmp.sim$x1, y = tmp.sim$y1,
         ...
         col = "red") # observed relationship (sample draws)

    lines(x = tmp.sim$x1, y = tmp.sim$y2, type = "p", col = "darkgreen") # true relationship (sample draws)
    abline(a = summary(tmp.sim$fit.01)$coefficients[1,1], b = summary(tmp.sim$fit.01)$coefficients[2,1], lty = 2, col = "red", lwd = 2) # observed relationship (estimated regression line)
    abline(a = summary(tmp.sim$fit.02)$coefficients[1,1], b = summary(tmp.sim$fit.02)$coefficients[2,1], lty = 2, col = "darkgreen", lwd = 2) # true relationship (estimated regression line)
  ...
  output$Plot0102 <- renderPlot({
    ...
    # illustration
    plot(x = tmp.sim$x1, y = tmp.sim$res.03,
         xlab = "X", ylab = "u",
         # xlim = c(0, 150), ylim = c(0, 150),
         col = "red")
