...
run_app <- function (url = "https://github.com/mmoessler/illustration-statistical-concepts/raw/main/r-shiny/ols-case-xx.zip") {
  ...
  file.path <- file.path(appdir, "ols_case_xx_document.rmd")
  file.path
...
run_app(url = "https://github.com/mmoessler/illustration-statistical-concepts/raw/main/r-shiny/ols-case-xx.zip")
